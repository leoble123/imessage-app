...
internal interface UniffiLib : Library {
    ...
    fun uniffi_imessage_core_fn_method_imessagecore_switch_relay(`ptr`: Pointer,`host`: RustBuffer.ByValue,`code`: RustBuffer.ByValue,`token`: RustBuffer.ByValue,
    ): Long
    ...
    fun uniffi_imessage_core_checksum_method_imessagecore_switch_relay(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    ...
    if (lib.uniffi_imessage_core_checksum_method_imessagecore_switch_relay() != 16242.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface ImessageCoreInterface {
     ...
     */
    suspend fun `switchRelay`(`host`: kotlin.String, `code`: kotlin.String, `token`: kotlin.String?)
...
open class ImessageCore: Disposable, AutoCloseable, ImessageCoreInterface {
    ...
    @Throws(CoreException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `switchRelay`(`host`: kotlin.String, `code`: kotlin.String, `token`: kotlin.String?) {
        return uniffiRustCallAsync(
        callWithPointer { thisPtr ->
            UniffiLib.INSTANCE.uniffi_imessage_core_fn_method_imessagecore_switch_relay(
                thisPtr,
                FfiConverterString.lower(`host`),FfiConverterString.lower(`code`),FfiConverterOptionalString.lower(`token`),
            )
        },
